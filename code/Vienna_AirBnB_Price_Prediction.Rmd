...
When I set the model formulas, I will include a number of interaction terms which involve the **neighbourhood** variable. These interaction terms have the potential to improve predictive performance, and methods like LASSO and Random Forest can select the terms which are most useful.  

# Model Building

## Training and Test Sets

The data needs to be split into training and test sets. The test set will only be used for model evaluation.  
