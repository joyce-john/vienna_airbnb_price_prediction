...
I reduce the size of the dataframe to only include columns which might be useful for the modeling task. (I also keep the ID and name columns in case we ever want to diagnose and discuss individual observations.)   
